...
<table border="0" align="left" width="90%" class="">
  ...
  <table border="1" id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      <?php
      $no = 1;
      $sql = $koneksi->query("SELECT p.*, u.nama_lengkap FROM permohonan_akta p JOIN users u ON p.id_user = u.id_user ORDER BY id_permohonan DESC
     ");
      ...
      ?>
        ...
        <tr>
          ...
          <td>
            <?php echo $data['catatan_perubahan']; ?>
          </td>
          <td>
